...
public class LoggingInterceptorTest {
    ...
    public void shouldLogResponseHeadersAndBodyForGetRequest() throws IOException {
        ...
        // Prepare a mock response
        ClientHttpResponse mockResponse = new MockClientHttpResponse(
            new ByteArrayInputStream(body.getBytes(StandardCharsets.UTF_8)), 200);
        ...
        assertEquals(body, new String(capturedResponse.getBody().readAllBytes(), StandardCharsets.UTF_8));
    }
